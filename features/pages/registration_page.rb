...
def stub_create_contact
  stub_request(:post, "http://test.host/contacts").
        with(:body => "{\"errors\":{},\"handle\":\"PH1420041600.000\",\"name\":\"Contact Contactson\",\"local_name\":\"\",\"organization\":\"Contacts R Us\",\"local_organization\":\"\",\"street\":\"123 Contact St.\",\"local_street\":\"\",\"street2\":\"\",\"local_street2\":\"\",\"street3\":\"\",\"local_street3\":\"\",\"city\":\"Contactville\",\"local_city\":\"\",\"state\":\"\",\"local_state\":\"\",\"postal_code\":\"\",\"local_postal_code\":\"\",\"country_code\":\"PH\",\"local_country_code\":\"\",\"voice\":\"+63.2000000\",\"voice_ext\":\"\",\"fax\":\"\",\"fax_ext\":\"\",\"email\":\"contact@test.fake\",\"validation_context\":null}",
...
def stub_registration
  stub_request(:post, "http://test.host/orders").
        with(:body => "{\"currency_code\":\"USD\",\"order_details\":[{\"type\":\"domain_create\",\"domain\":\"domain.ph\",\"authcode\":\"dummy-code\",\"period\":1,\"registrant_handle\":\"PH1420041600.000\"}]}",
             :headers => {'Accept'=>'application/json', 'Authorization'=>'Token token=abcd123456', 'Content-Type'=>'application/json'}).
