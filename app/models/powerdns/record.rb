class Powerdns::Record
  ...
  def self.check_if_exists name, content, type, srv_port, srv_weight, srv_content, token
    site = Rails.configuration.api_url
    url = "#{site}/powerdns/records"
    params = {name: name, content: content, type: type, srv_port: srv_port, srv_weight: srv_weight, srv_content: srv_content}.to_query
