...
set :log_level, :info
set :linked_files, %w{config/secrets.yml config/api.yml config/exception_notification.yml config/checkout.yml config/whois.yml config/paypal.yml config/paypal_redirect_urls.yml, config/dragonpay.yml}
