...
describe Contact do
  ...
  describe :valid? do
    ...
    specify { subject.local_organization  = nil;  subject.valid?.must_equal false }
    ...
    specify { subject.name  = nil;  subject.valid?.must_equal true }
    specify { subject.organization  = nil;  subject.valid?.must_equal true }
    specify { subject.street  = nil;  subject.valid?.must_equal true }
    specify { subject.city  = nil;  subject.valid?.must_equal true }
    specify { subject.country_code  = nil;  subject.valid?.must_equal true }

    specify { subject.local_postal_code ='12)(b@!#$'; subject.valid?.must_equal false }
    ...
    specify { subject.local_name  = ''; subject.valid?.must_equal false }
    specify { subject.local_organization  = ''; subject.valid?.must_equal false }
    specify { subject.local_street  = ''; subject.valid?.must_equal false }
    specify { subject.local_city  = ''; subject.valid?.must_equal false }
    specify { subject.local_country_code  = ''; subject.valid?.must_equal false }

    specify { subject.voice = ''; subject.valid?.must_equal false }
    specify { subject.email = ''; subject.valid?.must_equal false }

    specify { subject.name  = ''; subject.valid?.must_equal true }
    specify { subject.organization  = ''; subject.valid?.must_equal true }
    specify { subject.street  = ''; subject.valid?.must_equal true }
    specify { subject.city  = ''; subject.valid?.must_equal true }
    specify { subject.country_code  = ''; subject.valid?.must_equal true }

    specify { subject.local_postal_code = '12'; subject.valid?.must_equal false }
    ...
    specify { subject.local_name = '123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 X'; subject.valid?.must_equal false }
    specify { subject.local_organization  = '123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 X';  subject.valid?.must_equal false }
    specify { subject.local_street = '123456789 123456789 123456789 123456789 123456789 X'; subject.valid?.must_equal false }
    specify { subject.local_city  = '123456789 123456789 123456789 123456789 123456789 X'; subject.valid?.must_equal false }
    specify { subject.local_postal_code = '123456789 X'; subject.valid?.must_equal false }
